...
public enum UserExceptionEnum {
	...
	Connecttion_error(104),

	User_Not_found_Exception(201), Invalid_username(202), Invalid_password(203), You_arenot_allowed_To_Login(204),
	Please_refer_To_Your_Vendor(205);
